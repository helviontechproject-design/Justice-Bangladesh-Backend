...
const UserSchema = new mongoose_1.default.Schema({
    ...
    lawyer: mongoose_1.default.Schema.Types.ObjectId,
    notifications: { type: [mongoose_1.default.Schema.Types.ObjectId], default: [] },
    auths: { type: Array, default: [] },
    fcmTokens: { type: [String], default: [] },
}, { timestamps: true });
const WalletSchema = new mongoose_1.default.Schema({
    lawyerId: mongoose_1.default.Schema.Types.ObjectId,
...
const LawyerSchema = new mongoose_1.default.Schema({
    ...
    educations: [String],
    walletId: mongoose_1.default.Schema.Types.ObjectId,
    availability: [mongoose_1.default.Schema.Types.ObjectId],
    work_experience: Array,
    specialties: [mongoose_1.default.Schema.Types.ObjectId],
    categories: [mongoose_1.default.Schema.Types.ObjectId],
    services: [mongoose_1.default.Schema.Types.ObjectId],
    reviews: [mongoose_1.default.Schema.Types.ObjectId],
    ...
    isOnline: { type: Boolean, default: false },
    withdrawals: [mongoose_1.default.Schema.Types.ObjectId],
}, { timestamps: true });
...
const LawyerProfile = mongoose_1.default.model('LawyerProfile', LawyerSchema);
// ─── Dummy Data ──────────────────────────────────────────────────────────────
const LAWYERS = [
    {
        phone: '+8801711000001',
...
function seed() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const data of LAWYERS) {
            ...
            const existing = yield User.findOne({ 'phoneNo.value': data.phone });
            if (existing) {
            ...
            try {
                ...
                const [profile] = yield LawyerProfile.create([{
                        userId: user._id,
                        profile_Details: {
                ...
                // 3. Create Wallet
                const [wallet] = yield Wallet.create([{ lawyerId: profile._id, balance: 0 }], { session });
                ...
                const [avail] = yield Availability.create([{
                ...
                yield LawyerProfile.findByIdAndUpdate(profile._id, { walletId: wallet._id, availability: [avail._id] }, { session });
                // 6. Link lawyer to user
                yield User.findByIdAndUpdate(user._id, { lawyer: profile._id }, { session });
