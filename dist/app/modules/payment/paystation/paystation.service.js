...
const initiatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (payload.checkout_items)
            formData.append('checkout_items', payload.checkout_items);
        ...
        const response = yield axios_1.default.post(`${PAYSTATION_BASE_URL}/initiate-payment`, formData, {
        ...
        if (error.isAxiosError) {
            ...
            throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, `PayStation Error: ${(errorData === null || errorData === void 0 ? void 0 : errorData.message) || error.message}`);
        }
...
const checkTransactionStatus = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield axios_1.default.post(`${PAYSTATION_BASE_URL}/transaction-status`, {
            invoice_number: payload.invoice_number,
        }, {
            headers: {
        ...
        if (error.isAxiosError) {
            ...
            throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, `PayStation Status Error: ${(errorData === null || errorData === void 0 ? void 0 : errorData.message) || error.message}`);
        }
