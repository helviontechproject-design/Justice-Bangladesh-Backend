...
exports.formatMonthString = exports.getCurrentMonthRange = exports.getCurrentYearRange = exports.buildPaginationMeta = exports.buildDateRangeFilter = void 0;
...
exports.getCurrentYearRange = getCurrentYearRange;
...
const formatMonthString = (year, month) => {
    const monthStr = month.toString().padStart(2, '0');
    return `${year}-${monthStr}`;
};
exports.formatMonthString = formatMonthString;
